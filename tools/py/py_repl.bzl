...
#
# Originally from: https://github.com/tensorflow/tensorboard/blob/b87b8b68a687ed64fa78c14c9f2cd8f28231a9fe/tensorboard/defs/py_repl.bzl
...
def py_repl2(name, deps, **kwargs):
    interpreter_tpl = _dedent("""\
    import os
    import sys
